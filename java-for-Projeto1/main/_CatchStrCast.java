...
public class _CatchStrCast extends _Any
 {

	private static final long serialVersionUID = -1908257766227446976L;
    static { 
        try {

          _CatchStrCast.prototype = new _CatchStrCast();
        }
...
"prototype"); 
    ...
    public     _CatchStrCast() {

        } 

    public main._CatchStrCast _new() {
         
            return new _CatchStrCast();        
        } 

    private void  _eval_1_ExceptionStr( _ExceptionStr _e )  {
        CyString tmp407 = _e._message();

        CyString _msg;
        _msg = tmp407;
        _Nil tmp408 = _Nil.prototype;
        (new CyString("ExceptionStr throw with message " + _msg._asString().s))._println();
        return ;
        } 

    private void  _eval_1_ExceptionCast( _ExceptionCast _e )  {
        CyString tmp409 = _e._message();

        CyString _msg;
        _msg = tmp409;
        _Nil tmp410 = _Nil.prototype;
        (new CyString("End of program: ExceptionCast throw with message: " + _msg._asString().s + "."))._println();
        _Nil tmp411 = _Nil.prototype;
        _System.prototype._exit_1( CyInt.one);
        return ;
        } 

    public @Override main._CatchStrCast _prototype() {
         return prototype;
        
        } 

    public @Override main._CatchStrCast _clone() {
        
        try {
            return (_CatchStrCast ) this.clone(); 
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp412 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp412;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp413 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp414 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp414;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public void  _eval_1( Object _e )   {
        if ( _e instanceof _ExceptionStr  ) { 
            /*### returnType is cyan.lang.Nil */
            _eval_1_ExceptionStr((_ExceptionStr) _e);
        }
    ...
    public static _CatchStrCast prototype;
    ...
    static CyString []methodNameList = { 
        ...
        new CyString("prototype -> main.CatchStrCast"),
        new CyString("clone -> main.CatchStrCast"),
    ...
    static final String prototypeName = "CatchStrCast";
